...
def UI_Page():  # 进行图像界面显示
    ...
    page_setting_guide = {
        ...
        HOTSEARCH_PAGE_ID: ("热搜：设置刷新时间", 4, (1, "content")),
        PING_PAGE_ID: ("网络延迟：设置测试目标", 4, (1, "content")),
        TIMER_PAGE_ID: ("番茄钟：设置时长", 4, (2, "content")),
        WORLDCLOCK_PAGE_ID: ("世界时钟：设置时区", 4, (2, "content")),
        MEMO_PAGE_ID: ("纪念日：设置列表", 4, (3, "content")),
        TODO_PAGE_ID: ("待办事项：设置列表", 4, (3, "content")),
    ...
    def _make_gauge_row(label, var, color_var):
    ...
    gauge_cpu_temp_color_var = _make_gauge_row("CPU温度", gauge_cpu_temp_var, tk.StringVar(gauge_frame, config_obj.gauge_cpu_temp_color))
    gauge_gpu_color_var = _make_gauge_row("GPU", gauge_gpu_var, tk.StringVar(gauge_frame, config_obj.gauge_gpu_color))
    gauge_gpu_temp_color_var = _make_gauge_row("GPU温度", gauge_gpu_temp_var, tk.StringVar(gauge_frame, config_obj.gauge_gpu_temp_color))
    gauge_fan_color_var = _make_gauge_row("风扇", gauge_fan_var, tk.StringVar(gauge_frame, config_obj.gauge_fan_color))
