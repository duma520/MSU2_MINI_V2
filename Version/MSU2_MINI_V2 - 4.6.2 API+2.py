...
以上所有控制命令也可通过 TCP/UDP/WebSocket 等协议发送（type 字段同名小写：page_next/page_prev/key/orientation/marquee/config_set/device_select/device_refresh/notify/quit/health/version/protocols/status/config_get/screenshot）</pre>
</body></html>"""
